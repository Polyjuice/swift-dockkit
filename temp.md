...
Does the adding of desktop follow this principle.

I.e
```
addNewDesktop -> read json layout -> create a new json layout -> send to
    reactive reconsiler
```

I.e. there must be no side loading of panels/desktops/windows that does not
